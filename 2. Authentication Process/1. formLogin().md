...
2. 내부적으로 UsernamePasswrodAuthenticationFilter가 생성되어 폼 방식의 인증 처리를 담당하게 됨
```java
HttpSecurity.formLogin(httpSecurityLoginConfigurer ->
    httpSecurityFormLoginConfigurer
        ...
        .failureHandler(AuthenticationFailHandler) // 인증 실패 시 사용할 AuthenticationFailureHandler (기본값 : SimpleUrlAuthenticationFailureHandler를 사용하여 "/login?error"로 Redirection)
